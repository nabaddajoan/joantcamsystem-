              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    $sql = "SELECT *, SUM(num_hr) AS total_hr, attendance.teacher_id AS empid FROM attendance LEFT JOIN teachers ON teachers.id=attendance.teacher_id LEFT JOIN subject ON subject.id=teachers.position_id WHERE date BETWEEN '$from' AND '$to' GROUP BY attendance.teacher_id ORDER BY teachers.lastname ASC, teachers.firstname ASC";
