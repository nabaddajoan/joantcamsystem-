            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="attendance_add.php">
                <div class="form-group">
                    <label for="employee" class="col-sm-3 control-label">Teacher ID</label>
                ...
                <div class="form-group">
                    <label for="time_in" class="col-sm-3 control-label">Number Of Days</label>
                ...
                <div class="form-group">
                    <label for="days" class="col-sm-3 control-label">percentage attendance</label>

                    <div class="col-sm-9">
                      <div class="bootstrap-timepicker">
                        <input type="text" class="form-control timepicker" id="percentage" name="time_out">
                      </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="individual_edit.php">
