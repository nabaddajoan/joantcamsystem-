          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, overtime.id AS otid, teachers.teacher_id AS empid FROM overtime LEFT JOIN teachers ON teachers.id=overtime.teacher_id ORDER BY date_overtime DESC";
