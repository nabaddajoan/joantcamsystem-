...
<?php 
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      $sql = "SELECT teachers.teacher_id , teachers.firstname, teachers.lastname,count(case when status ='1' then 1 end) as days_present ,count(case when status ='0' then 1 end) as days_absent ,(count(case when status = 1 then 1 end) / ( 10) *100 ) as percentage from attendance left join teachers on attendance.teacher_id = teachers.id where date between '2019-01-01' and '2065-01-31' GROUP by teachers.teacher_id";
