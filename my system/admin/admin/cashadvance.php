          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, cashadvance.id AS caid, teachers.teacher_id AS empid FROM cashadvance LEFT JOIN teachers ON teachers.id=cashadvance.teacher_id ORDER BY date_advance DESC";
